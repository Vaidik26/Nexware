     ...
     <View className="flex-row gap-2">
      {unboxedPickedCount > 0 && (
       ...
       >
        ...
        <Text className="font-bold ml-2 text-blue-700">
   ...
   <Modal visible={showBoxModal} transparent animationType="slide">
    <View className="flex-1 bg-black/50 justify-end">
     <View className="bg-white rounded-3xl p-6 w-full shadow-2xl">
      <Text className="text-xl font-bold text-gray-800 mb-4 ">Pack Loose Items</Text>
    ...
    <View className="flex-1 bg-black/60 items-center justify-center px-6">
     <View className="bg-white rounded-3xl p-8 w-full shadow-2xl items-center border border-gray-100">
      ...
      <View className="w-full bg-gray-50 p-4 rounded-xl mb-6">
       <Text className="text-xs text-gray-500 text-center mb-1">DATA PAYLOAD</Text>
      ...
      <View className="flex-row justify-between w-full mb-4 gap-3">
       ...
       >
        <Text className="text-gray-700 font-bold text-sm">Share</Text>
       </TouchableOpacity>
      </View>
      ...
      >
       {isSubmitting ? <ActivityIndicator color="white" /> : (
        <>
         ...
         <Text className="text-white font-bold text-base ml-2">Submit Order to Admin</Text>
        </>
       )}
      </TouchableOpacity>
     </View>
